<div class="teachers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('vname'); ?></th>
			<th><?php echo $this->Paginator->sort('bildname'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($teacher['Teacher']['vname']); ?>&nbsp;</td>
		<td><?php echo h($teacher['Teacher']['bildname']); ?>&nbsp;</td>
